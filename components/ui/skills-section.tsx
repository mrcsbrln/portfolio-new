...
const skills: Skill[] = [
  ...
  { name: "REST API", Icon: IconRestAPI },
    ...
    >
      <div className="w-10 h-10 flex items-center justify-center">
        <skill.Icon
          width={40}
          height={40}
          className="w-full h-full brightness-0 invert opacity-70 group-hover:opacity-100 transition-opacity duration-200"
        />
      </div>
...
export function SkillsSection() {
  return (
    <section
      id="skills"
      className="w-full min-h-dvh bg-neutral-900 py-14 md:py-16 flex flex-col justify-center"
    >
      <div className="w-full max-w-360 mx-auto px-6">
        ...
        <motion.p
          ...
          className="font-mono text-xs tracking-[0.2em] uppercase text-neutral-500 mb-6"
        >
          02 / Skills
        </motion.p>

        {/* Main layout: left text + vertical rule + right icons */}
        <div className="grid grid-cols-1 md:grid-cols-[3fr_1px_2fr] gap-0">
          {/* Left: text */}
          <motion.div
            ...
            className="pr-0 md:pr-12 lg:pr-20 pb-10 md:pb-0"
          >
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-white mb-5">
              What I work with
            </h2>
            ...
            <div className="space-y-5">
              ...
              <div className="border-t border-white/10 pt-4">
                <p className="font-mono text-base tracking-[0.18em] uppercase text-neutral-500 mb-2">
                  Core Stack & Frameworks
                </p>
                <div className="space-y-1.5 text-base text-neutral-400 leading-normal">
                  <p>
          ...
          {/* Right: icon grid */}
          <div className="pl-0 md:pl-10 lg:pl-16 flex items-center justify-center">
            <motion.div
              initial="hidden"
              whileInView="visible"
