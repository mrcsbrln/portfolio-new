...
const skills = [
  ...
  {
    category: "Backend",
    items: ["Prisma", "Firebase", "Supabase"],
  },
  {
    category: "AI & Automation",
    items: ["Claude Code", "n8n"],
  },
  {
    category: "Tools",
...
export function SkillsSection() {
  return (
    <section
      id="skills"
      className="w-full min-h-dvh bg-neutral-50 dark:bg-neutral-900 py-28 md:py-36 flex flex-col justify-center"
    >
